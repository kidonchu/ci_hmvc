...
if ( ! function_exists('asset_url'))
{
    function asset_url()
    {
        ...
        return base_url() . $CI->config->item('asset_path', 'asset');
    }
}
...
if ( ! function_exists('css_url'))
{
    ...
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('css_path', 'asset');
    }
}
...
if ( ! function_exists('less_url'))
{
    ...
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('less_path', 'asset');
    }
}
...
if ( ! function_exists('js_url'))
{
    ...
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('js_path', 'asset');
    }
}
...
if ( ! function_exists('img_url'))
{
    ...
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('img_path', 'asset');
    }
}
...
if ( ! function_exists('swf_url'))
{
    ...
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('swf_path', 'asset');
    }
}
...
if ( ! function_exists('upload_url'))
{
    ...
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('upload_path', 'asset');
    }
}
...
if ( ! function_exists('download_url'))
{
    ...
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('download_path', 'asset');
    }
}
...
if ( ! function_exists('xml_url'))
{
    ...
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('xml_path', 'asset');
    }
}
